...
public class CartLocators {
    ...
    public static By buttonIncreaseItemQty = By.xpath("//android.widget.ImageView[@content-desc='Increase item quantity']");
    ...
    public static By textViewItemQty = By.xpath("//android.widget.TextView[@resource-id='com.saucelabs.mydemoapp.android:id/noTV']");

    public static By scrollToBottomInScrollView() {
